...
- [x] **1. Establish Directory Structure**
...
- [x] **2. Create the `AssetBuilder` Tool**
...
- [x] **3. Implement Mesh Cooking (Offline Conversion)**
...
- [x] **4. Implement Texture Processing & Channel Packing**
...
- [ ] **7. Mesh Optimizer**
  - Optimizing geometry for cache efficiency
...
- [x] **1. Implement `gpuMalloc` Architecture**
...
- [x] **3. Bindless Texture Heap (Argument Buffers)**
...
- [x] **4. Migrate to Raw Memory Loads**
